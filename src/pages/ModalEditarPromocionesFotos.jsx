...
const ModalEditarPromocionesFotos = (datosProfesor) => {
    ...
    const confirmarModificar = () => {
        ...
        if (!modificarProfesor.datosProfesor.data.titulo || !modificarProfesor.datosProfesor.data.descripcion || !modificarProfesor.datosProfesor.data.tiempo) {
            Swal.fire({
            ...
            Swal.fire({
                ...
                text: "Modificarás permanentemente este personal!",
                icon: "warning",
    ...
    return (
        <div className="w-full">
            <div className="p-2 bg-white rounded-lg shadow-lg">
                <h3 className="text-3xl font-semibold text-center text-gray-500 mt-4 mb-2">Editar Paquete</h3>
                <form onSubmit={handleSubmit} className="pl-8 pr-8">
                    <div className="mb-2">
                        <label htmlFor="titulo" className="block mb-1 text-sm text-gray-600">Título</label>
                        <input
                            type="text"
                            id="titulo"
                            name="titulo"
                            ...
                            value={modificarProfesor.datosProfesor.data.titulo}
                    ...
                    <div className="mb-2">
                        <label htmlFor="descripcion" className="block mb-1 text-sm text-gray-600">Descripción</label>
                        <textarea
                            id="descripcion"
                            name="descripcion"
                            className="class-input text-sm w-full px-4 py-1 border border-gray-600 rounded-lg focus:outline-none focus:border-cyan-500"
                            value={modificarProfesor.datosProfesor.data.descripcion}
                            onChange={(event) => setModificarProfesor(prevState => ({
                                ...prevState,
                                datosProfesor: {
                                    ...prevState.datosProfesor,
                    ...
                    <div className="mb-2">
                        <label htmlFor="precio" className="block mb-1 text-sm text-gray-600">Precio</label>
                        <input
                            type="text"
                            id="precio"
                            name="precio"
                            className="class-input text-sm w-full px-4 py-1 border border-gray-600 rounded-lg focus:outline-none focus:border-cyan-500"
                            value={modificarProfesor.datosProfesor.data.precio}
                            onChange={(event) => setModificarProfesor(prevState => ({
                                ...prevState,
                                datosProfesor: {
                                    ...prevState.datosProfesor,
                    ...
                    <div className="mb-2">
                        <label htmlFor="tiempo" className="block mb-1 text-sm text-gray-600">Tiempo</label>
                        <input
                            type="number"
                            id="tiempo"
                            name="tiempo"
                            className="class-input text-sm w-full px-4 py-1 border border-gray-600 rounded-lg focus:outline-none focus:border-cyan-500"
                            value={modificarProfesor.datosProfesor.data.tiempo}
                            onChange={(event) => setModificarProfesor(prevState => ({
                                ...prevState,
                                datosProfesor: {
                                    ...prevState.datosProfesor,
...
export default ModalEditarPromocionesFotos;
