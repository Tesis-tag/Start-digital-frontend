...
import ModalEditarPagoAdmin from "./ModalEditarPagoAdmin";
...
const TablePagosAdministrador = () => {
  ...
  const confirmarEliminar = (idPago) => { // Cambiado de idProfesor a idPago
    Swal.fire({
      title: "¿Estás seguro de eliminarlo?",
      text: "¡Borrarás permanentemente este pago!",
      icon: "warning",
  ...
  const filteredPagos = pagos.filter((pago) =>
    eliminarAcentos(` ${pago.descripcion}`)
      .toLowerCase()
       ...
       <div className="flex">
        ...
        <div className="py-8 ">
          <div className=" flex flex-row tabla justify-between w-full mb-1 sm:mb-0">
            ...
            <h2 className="text-2xl leading-tight">Administrar Pagos</h2>
                    ...
                    currentItems.map((pago) => ( 
                      <tr key={pago.id}>
                        ...
                        <td className="">
                          ...
                          <button
    onClick={() => {
        setModificarProfesor(pago); // Asegúrate de que estás pasando el objeto correcto
...
>
    Ver Pago
                            ...
                            <button
                              onClick={() => confirmarEliminar(pago.id)} 
                              type="submit"
        ...
        isModalOpenModificar && (
          <div className="cont-modal " onClick={() => setIsModalOpenModificar(false)}>
            <div className="modal w-[450px] md:w-[600px] lg:w-[600px]" onClick={handleModalStop}>
              ...
              <ModalEditarPagoAdmin datosProfesor={modificarProfesor} />
            </div>
          </div>
        )
      }
        ...
        isModalOpen && (
          <div className="cont-modal " onClick={() => setIsModalOpen(false)}>
            <div className="modal w-[450px] md:w-[600px] lg:w-[600px]" onClick={handleModalStop}>
              ...
              <ModalVerPago datosProfesor={modificarProfesor} />
            </div>
          </div>
        )
      }
...
export default TablePagosAdministrador;
