      ...
      const registrarProfesor = async () => {
        ...
        if (!profesor.dependencia || !profesor.correo ){
            ...
            try {
                ...
                const response = await axios.post('https://start-digital.onrender.com/gestion/contacto/registrar', profesor).then(
                    Swal.fire({
                        title: "Registrado",
  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit} className="pl-8 pr-8">
            ...
            className="mt-6 w-32 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-500 hover:to-cyan-700 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 "
            >
            Registro
            </button>
        </form>
