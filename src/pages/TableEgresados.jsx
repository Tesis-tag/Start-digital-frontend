...
import ModalCrearEgresado from "./ModalCrearEgresado"
import ModalEditarEgresado from "./ModalEditarEgresado"
import Swal from "sweetalert2"
import './Modal.css'

const TableEgresados = () => {
...
const renderPageNumbers = () => {
  ...
  return (
    ...
    <div className="div-table">
          ...
          <ModalEditarEgresado datosProfesor={modificarProfesor} />
        </div>
              </div>
      )
    }
      ...
      <div className="py-8 ">
        ...
        <Link to="/gestion"><button className="w-24 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-500 hover:to-cyan-700 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mb-2">
          ...
          <h2 className="text-2xl leading-tight">Egresados</h2>
    ...
    <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead className="ltr:text-left rtl:text-right">
        <tr>
          ...
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Año de egreso</th>
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Carrera</th>
      ...
      <tbody className="divide-y divide-gray-200">
        ...
        currentItems.map((profesor) => (
          <tr key={profesor.id}>
            ...
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.anoEgreso}</td>
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.carrera}</td>
