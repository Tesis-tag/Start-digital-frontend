      ...
      */
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
              // Navegar a la ruta /gestion/noticias
  ...
  return (
    <div className="div-table">
      ...
      <div className=" flex flex-row tabla justify-between w-full mb-1 sm:mb-0">
        <Link to="/gestion/noticias"><button className="w-24 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-500 hover:to-cyan-700 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mb-2">
            Atrás
        </button></Link>
