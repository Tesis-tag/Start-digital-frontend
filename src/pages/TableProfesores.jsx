...
import './Modal.css'
import copy from '../img/copy2.svg'
...
const renderPageNumbers = () => {
  ...
  return (
    ...
    <div className="div-table">
          ...
          <ModificarProfesor datosProfesor={modificarProfesor} />
        </div>
              </div>
      )
    }
    ...
    <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead className="ltr:text-left rtl:text-right">
        <tr>
          ...
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Materia</th>
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Correo</th>
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Roll</th>
      ...
      <tbody className="divide-y divide-gray-200">
        ...
        currentItems.map((profesor) => (
          <tr key={profesor.id}>
            ...
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.codigoMateria1}</td>
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.correo}</td>
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.roll}</td>
