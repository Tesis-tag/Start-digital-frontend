...
import ModalCrearServicioComunity from "./ModalCrearServicioComunity"
  ...
  return (
    ...
    <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead className="ltr:text-left rtl:text-right">
        <tr>
          <th className="whitespace-nowrap pr-1 pl-4 py-2 font-medium text-gray-900">Plan</th>
      ...
      <tbody className="divide-y divide-gray-200">
        ...
        currentItems.map((profesor) => (
          <tr key={profesor.id}>
            ...
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.titulo}</td>
...
export default TableServiciosComunity