...
const ModalModificarProfesor = (isModalOpenModificar, idProfesor) => {

    const [nombre, setNombre] = useState("")

    useEffect(() => {
        setNombre(idProfesor);
    }, [idProfesor]);


    
    if (isModalOpenModificar === false) {
        return null;
    }
  return (
    <>
       ...
       {/** <Link to="/"><button className="bg-transparent hover:bg-white text-white font-semibold hover:text-gray-600 py-2 px-6 border border-white hover:border-transparent rounded mb-2">
        ...
        <h1 className="text-3xl font-semibold text-center text-gray-500 mt-8 mb-6">Registrar Profesor</h1>
...
export default ModalModificarProfesor