...
const ModalEditarContacto = (datosProfesor) => {
    ...
    const modificarEstadoProfesor = async () => {
        ...
        try {
              const response = await axios.put(`https://start-digital.onrender.com/gestion/contacto/editar/${modificarProfesor.datosProfesor.id}`, modificarProfesor.datosProfesor.data)
         ...
         <div className=" w-full" >
          ...
          <form onSubmit={handleSubmit} className="pl-8 pr-8">
            ...
            <label htmlFor="dependencia" className="block mb-1 text-sm text-gray-600">
              ...
              type="button"
              className="mt-4 w-32 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-500 hover:to-cyan-700 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mb-2"
              >
              Modificar
              </button>
          </form>
