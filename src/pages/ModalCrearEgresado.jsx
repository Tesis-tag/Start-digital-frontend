...
const ModalCrearEgresado = () => {
    ...
    const [profesor, setProfesor] = useState({
      ...
      const registrarProfesor = async () => {
        ...
        if (!profesor.nombre || !profesor.anoEgreso ||  !profesor.carrera ||  !acceptedFiles[0]){
            Swal.fire({
            ...
            try {
                ...
                const response = await axios.post('https://start-digital.onrender.com/gestion/egresados/registrar', formData, {
                    headers: {
  ...
  return (
    <>
        ...
        <h3 className="text-3xl font-semibold text-center text-gray-500 mt-0 mb-2">Registrar Egresado</h3>
        <form onSubmit={handleSubmit} className="pl-8 pr-8">
            ...
            <div className="mb-2">
            <label htmlFor="anoEgreso" className="block  text-sm text-gray-600">
                Año de egreso
            </label>
            <input
                ref={correoRef}
            ...
            <div className="mb-2">
            <label htmlFor="carrera" className="block  text-sm text-gray-600">
                Carrera
            <input
...
export default ModalCrearEgresado