...
const ModalEditarPreguntaFrecuente = (datosProfesor) => {
    ...
    const modificarEstadoProfesor = async () => {
        ...
        try {
              const response = await axios.put(`http://localhost:9000/gestion/preguntas-frecuentes/editar/${modificarProfesor.datosProfesor.id}`, modificarProfesor.datosProfesor.data)
