...
import ModalVerMensaje from "./ModalVerMensaje"
     ...
     <div className="flex">
      ...
      <div className="py-8 ">
        <div className=" flex flex-row tabla justify-between w-full mb-1 sm:mb-0">
          ...
          <h2 className="text-2xl leading-tight">Mensajes</h2>
      ...
      <tbody className="divide-y divide-gray-200">
        ...
        currentItems.map((profesor) => (
          <tr key={profesor.id}>
            ...
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.mensaje}</td>
                        <td className="">
            ...
            <form className="px-0 pb-2">
              <div>
                ...
                <textarea
                  ...
                  value={modificarProfesor ? modificarProfesor.data.mensaje : ''} // Establecer el valor aquí
                  onChange={(e) => setModificarProfesor({ ...modificarProfesor, data: { ...modificarProfesor.data, mensaje: e.target.value } })} // Manejar cambios
                />
              </div>
            </form>
          </div>
