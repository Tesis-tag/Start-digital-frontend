      ...
      const registrarMateria = async () => {
        if (!materia.semestre || !materia.asignatura || !materia.codigo){
            ...
            try {
                ...
                const response = await axios.post('https://start-digital.onrender.com/materias/matematica/registrar', materia, {
...
export default CrearMateriaMatematica