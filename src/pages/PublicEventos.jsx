      ...
      <div id="inicio" className="page">
        ...
        <section className="sec-general-banner">
          <div className="cont-h1-tele">
            <h1 className="h1-tele font-robot font-normal text-white ">Eventos</h1>
          </div>
        </section>
        <div className="contenido">
          <section className="section-profesores">
          <h1 className="h1-pags">Eventos de Start Digital</h1>
<div className="cont-intro flex justify-center mb-4">
  <p className="text-center text-gray-600 mb-8 px-4">En Start Digital, nos emociona compartir con nuestra comunidad los próximos eventos y actividades que hemos planeado. Te invitamos a explorar nuestra sección de eventos, donde encontrarás información sobre talleres, sesiones de fotos, seminarios y otras oportunidades para interactuar y aprender más sobre fotografía y gestión de redes sociales. ¡No te pierdas la oportunidad de participar y potenciar tu negocio!</p>
</div>
