...
const ModificarMateriaProduccion = (datosMaterias) => {
    ...
    const modificarEstadoMateria = async () => {
        ...
        try {
              const response = await axios.put(`https://start-digital.onrender.com/materias/produccion/editar/${modificarMateria.datosMaterias.id}`, modificarMateria.datosMaterias.data)
...
export default ModificarMateriaProduccion