...
import ModalCrearPersonalAdministrativo from "./ModalCrearPersonalAdministrativo"
import ModalEditarPersonalAdministrativo from "./ModalEditarPersonalAdministrativo" 
import Swal from "sweetalert2"
import './Modal.css'

const TablePersonlaAdministrativo = () => {
...
const renderPageNumbers = () => {
  ...
  return (
    ...
    <div className="div-table">
          ...
          < ModalCrearPersonalAdministrativo/>
        </div>
              </div>
      )
    }
          ...
          <ModalEditarPersonalAdministrativo datosProfesor={modificarProfesor} />
        </div>
              </div>
      )
    }
      ...
      <div className="py-8 ">
        ...
        <Link to="/gestion"><button className="w-24 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-500 hover:to-cyan-700 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mb-2">
          ...
          <h2 className="text-2xl leading-tight">Personal Administrativo</h2>
    ...
    <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead className="ltr:text-left rtl:text-right">
        <tr>
          ...
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Cargo</th>
      ...
      <tbody className="divide-y divide-gray-200">
        ...
        currentItems.map((profesor) => (
          <tr key={profesor.id}>
            ...
            <td className="whitespace-nowrap px-2 py-2 text-gray-700 text-center"> {profesor.data.cargo}</td>
...
export default TablePersonlaAdministrativo